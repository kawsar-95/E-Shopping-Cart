const addItemButton = document.getElementById("addItem");
      ...
      addItemButton1.addEventListener("click", function () {
         ...
         document.getElementById("subtotal").innerText = parseFloat(document.getElementById("casePrice").innerText);
         document.getElementById("total").innerText = parseFloat(document.getElementById("casePrice").innerText);
      })
      ...
      addItemButton2.addEventListener("click", function () {
         ...
         document.getElementById("casePrice").innerText = 0;
         document.getElementById("subtotal").innerText = parseFloat(document.getElementById("iphonePrice").innerText);
         document.getElementById("total").innerText = parseFloat(document.getElementById("iphonePrice").innerText);
      })
      // function
